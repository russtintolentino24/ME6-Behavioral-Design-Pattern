...
public class GetTheCrypto implements Runnable{
    ...
    public void run(){
        ...
        for(int i = 1; i <= 20; i++){
            ...
            if(crypto == "BitCoin") ((CryptoGrabber) cryptoGrabber).setBitCoinPrice(price);
            if(crypto == "Doge") ((CryptoGrabber) cryptoGrabber).setDogePrice(price);
            if(crypto == "SLP") ((CryptoGrabber) cryptoGrabber).setSLPPrice(price);
